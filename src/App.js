...
const s = {
  ...
  header: "flex1 Size font3 NavLogin",
  main: "flex8 white",
      ...
      return (
        <div className={s.container}>
          <div className={s.header} >
            ...
            <div className="click">
              <div className="click2" onClick={() => this.openModal()}>Home</div>
              <div className="click2" onClick={() => this.openModal()}>Cart</div>
              <div className="click2" onClick={() => this.openModal()}>Login</div>
            </div>
          </div>
